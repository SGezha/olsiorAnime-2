                ...
                <client-only>
                    <div class="absolute video-menu bottom-0 bg-neutral bg-opacity-70 video-menu w-[100%] p-[20px] h-[100px] transition-transform"
                        ...
                        <div class="grid grid-cols-5 md:flex md:items-center mt-[10px] gap-[10px]">
                            ...
                            <VideoMenu class="flex">
                                ...
                                <template #menu="{ close }">
                                    <div
                                        ...
                                        <VideoMenuItem @click="openTelegram(anime.attributes.episodes[current].tgLink)">
                            ...
                            <button class="btn videoBtn"
                                @click="toggle(); isFullscreen ? lockOrientation('landscape-primary') : lockOrientation('portrait')">
    ...
    <div class="mt-[30px]">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 mt-[10px] w-full gap-[10px]">
            <button v-for="(ep, ind) in anime.attributes.episodes" :key="ep.title" class="btn shadow-lg"
                :class="{ 'text-white bg-primary': current == ind }" @click="changeEpisode(ind, true)" :title="ep.title">
